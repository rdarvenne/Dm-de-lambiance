...
SparseMatrix<double> In(N,N) , Bn(N,N) , An(N,N), BnTBn(N,N) ,Q(N,N) , R(N,N);
...
//TEST QR ///////////////////////////////////
  ...
  // SparseQR< SparseMatrix<double, RowMajor>, COLAMDOrdering<int>> qr1 , qr2 , qr3 ;
  // qr1.analyzePattern(An);
  // qr1.factorize(An);
  // Q = qr1.matrixQ();
  // R = qr1.matrixR();
//  cout<<  "Q = "<<Q<<endl;
